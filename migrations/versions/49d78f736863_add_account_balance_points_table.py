...
def upgrade() -> None:
    ...
    op.drop_index('ix_investment_balance_points_date', table_name='investment_balance_points')
    op.drop_index('ix_investment_balance_points_id', table_name='investment_balance_points')
    op.drop_index('ix_investment_balance_points_investment_id', table_name='investment_balance_points')
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['account_id'], ['accounts.id'], name='investments_account_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['broker_id'], ['brokers.id'], name='investments_broker_id_fkey', ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='investments_user_id_fkey', ondelete='CASCADE'),
    ...
    op.create_index('ix_investments_broker_id', 'investments', ['broker_id'], unique=False)
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['investment_id'], ['investments.id'], name='investment_balance_points_investment_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='investment_balance_points_pkey')
    )
    op.create_index('ix_investment_balance_points_investment_id', 'investment_balance_points', ['investment_id'], unique=False)
    op.create_index('ix_investment_balance_points_id', 'investment_balance_points', ['id'], unique=False)
    op.create_index('ix_investment_balance_points_date', 'investment_balance_points', ['date'], unique=False)
